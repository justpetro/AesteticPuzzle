...
public abstract class Grid {
    //Classe che contiene tutte le info riguardo img e rotazioni
    //Si, l'ho copiata spudoratamente da internet, ma sticazzi, basta che funziona
    ...
    private ArrayList<Grid> reservedBy = new ArrayList<Grid>();
    ...
    public Grid (int orientation, int i, int j) {
        this.orientation = orientation;
        this.i=i;
        this.j=j;
    }

    public Grid(int orientation)
    {
        this.orientation=orientation;
    }
     ...
     */
    public static Grid getShapeFromStringId(String line, int i, int j) {
        switch(line) {
     ...
     * JAVA DOC ALBAN
     */
    public  abstract int[] getDomainWithPruning(LivelliInfinito livelliInfinito);
    ...
    public ArrayList<Grid> getReservedBy() {
        return reservedBy;
    }
     ...
     * @param reservedBy
     */
    public void setReservedBy(Grid reservedBy) {
    ...
    public boolean isConnectedTo(Grid s) {
        if(i == s.getI()) {
